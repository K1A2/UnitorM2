...
public class UnipackFileListViewAdapter extends BaseAdapter {
    ...
    public UnipackFileListViewAdapter() {
    ...
    public View getView (int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_unipack_select, parent, false);
        }

        TextView nameView = (TextView)convertView.findViewById(R.id.FragDial_file_name_select);
        TextView pathView= (TextView)convertView.findViewById(R.id.FragDial_file_path_select);
        ImageView icoView = (ImageView)convertView.findViewById(R.id.FragDial_file_Image_select);
